...
log "  4) 首次 deploy 前, 在 deploy 上下文提供 DATABASE_URL/USER/PASSWORD env，deploy 脚本会自举 aspnetcore.env"
log "     或 deploy 后手工编辑 \$BASE/aspnetcore.env（ConnectionStrings__Postgres + Jwt__* + Saas__Cors__AllowedOrigins）"
